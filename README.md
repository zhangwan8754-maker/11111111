...
**主网址：https://zhangwan8754-maker.github.io/11111111/**

**备用网址：https://cdn.jsdelivr.net/gh/zhangwan8754-maker/11111111@gh-pages/index.html**

- **手机**：用浏览器打开网址 → 浏览器菜单 → 「添加到主屏幕」，以后就能像 App 一样从桌面打开。
- **电脑**：浏览器打开同一个网址，收藏即可。
...
- 国内网络对 `*.github.io` 域名**时常拦截**，主网址打不开属于常见情况，换**备用网址**（jsDelivr CDN，国内一般可以访问）即可，内容完全相同。备用网址上的更新可能延迟几小时生效。
- 两个网址的本地数据是分开保存的，但只要都配置同一个 Token，数据就会通过云端自动互通。
- 应用支持**离线使用**：任一网址加载成功一次后，之后断网 / 网络被拦截也能正常打开和记录，等有网时再同步。
